        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                       ...
                       "/swagger-ui/**",
                        ...
                        .requestMatchers(HttpMethod.PUT, "/pessoa/update/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/pessoa/delete/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/livro/create").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/livro/update/*").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/livro/delete/*").hasRole("ADMIN")
